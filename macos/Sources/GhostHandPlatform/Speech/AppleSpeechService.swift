...
public enum SpeechInputError: Error, LocalizedError, Equatable {
    ...
    public var errorDescription: String? {
        ...
        case .microphoneDenied:
            return "GhostHand doesn't have microphone access. Allow it in System Settings → Privacy & Security → Microphone."
        case .speechRecognitionDenied:
            return "GhostHand doesn't have speech recognition access. Allow it in "
...
final class SpeechRecognitionSession: @unchecked Sendable {
    ...
    private let control = DispatchQueue(label: "com.ghosthand.mac.speech-session")
