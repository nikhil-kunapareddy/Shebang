...
public enum HotkeyError: Error, LocalizedError, Equatable {
    ...
    public var errorDescription: String? {
        switch self {
        case .accessibilityNotGranted:
            return "Shebang needs Accessibility access to listen for the Control+Command hotkey. "
                + "Enable it in System Settings → Privacy & Security → Accessibility, then relaunch Shebang."
        case .eventTapCreationFailed:
...
private final class HotkeyEventTap: @unchecked Sendable {
    ...
    func start() throws {
        ...
        thread.name = "Shebang.HotkeyEventTap"
