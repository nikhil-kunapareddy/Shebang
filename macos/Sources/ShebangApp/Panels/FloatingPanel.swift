...
/// Borderless floating panel that never activates Shebang, so the target app stays the active app.
...
final class FloatingPanel: NSPanel {
    ...
    /// Shows the panel above other apps' windows without activating Shebang.
