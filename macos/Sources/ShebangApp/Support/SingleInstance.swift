...
enum SingleInstance {
    ...
    static let showStatusNotification = Notification.Name("com.shebang.mac.showStatus")
    ...
    static func handOffToRunningInstance() -> Bool {
        ...
        Log.app.info("Shebang is already running (PID \(survivor.pid)); activating it and exiting")
